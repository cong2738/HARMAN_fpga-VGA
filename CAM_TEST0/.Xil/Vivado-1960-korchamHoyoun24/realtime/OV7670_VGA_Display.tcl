...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/harman/fpga-VGA/CAM_TEST0/.Xil/Vivado-1960-korchamHoyoun24/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      C:/harman/fpga-VGA/CAM_TEST0/CAM_TEST0.srcs/sources_1/new/RGB_filter.sv
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/harman/fpga-VGA/CAM_TEST0/.Xil/Vivado-1960-korchamHoyoun24/"
